...
let
  ...
  package = pkgs.buildGoModule {
    ...
    postPatch = ''
      ...
      substituteInPlace go.sum \
        --replace-fail "github.com/router-for-me/CLIProxyAPI/v7 v7.2.93 h1:qkPSuVXLV8+fcOoRJJxJOt/bt/k+OtsFWSjV6Tfcv8M=" \
          "github.com/router-for-me/CLIProxyAPI/v7 v${cliProxyApiSdkVersion} h1:Aj3J7zI5VxyKpsHbG6+ChVpeW4QGkcJ+ZwWWnWmuChA=" \
    ...
    vendorHash = "sha256-K4O+YekTJEQIS36OGYJuG7HRUME7CGYWJepD2P9RMfg=";
