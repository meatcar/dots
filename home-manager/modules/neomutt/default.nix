...
let
  ...
  mkAccountFile = name:
    let
      ...
      mbox = builtins.getAttr name { gmail = "[Gmail]/All\\ Mail"; fastmail = "Archive"; zoho = "Archives"; };
      archive = builtins.getAttr name { gmail = "[Gmail]/All "; fastmail = "Archive"; zoho = "Archives"; };
      drafts = builtins.getAttr name { gmail = "[Gmail]/Drafts"; fastmail = "Drafts"; zoho = "Drafts"; };
      trash = builtins.getAttr name { gmail = "[Gmail]/Trash"; fastmail = "Trash"; zoho = "Trash"; };
      spam = builtins.getAttr name { gmail = "[Gmail]/Spam"; fastmail = "Spam"; zoho = "Spam"; };
      sent = builtins.getAttr name { gmail = "[Gmail]/Sent\\ Mail"; fastmail = "Sent"; zoho = "Sent"; };
      color = builtins.getAttr name { gmail = "white"; fastmail = "blue"; zoho = "red"; };
    in
