#!/bin/sh
# Base16 3024 - Virtual console color setup script
# Jan T. Sott (http://github.com/idleberg)

color00="f7f7f7" # Base 07 - White
...
color07="4a4543" # Base 02 - Black
color08="a5a2a2" # Base 05 - Bright White
...
color15="090300" # Base 00 - Bright Black
