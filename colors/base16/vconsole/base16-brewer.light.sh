#!/bin/sh
# Base16 Brewer - Virtual console color setup script
# Timothée Poisot (http://github.com/tpoisot)

color00="fcfdfe" # Base 07 - White
...
color07="515253" # Base 02 - Black
color08="b7b8b9" # Base 05 - Bright White
...
color15="0c0d0e" # Base 00 - Bright Black
