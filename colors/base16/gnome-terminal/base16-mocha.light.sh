...
gset string palette "#f5eeeb:#cb6077:#beb55b:#f4bc87:#8ab3b5:#a89bb9:#7bbda4:#d0c8c6:#7e705a:#cb6077:#beb55b:#f4bc87:#8ab3b5:#a89bb9:#7bbda4:#3B3228"
gset string background_color "#f5eeeb"
gset string foreground_color "#645240"
gset string bold_color "#645240"
