...
gset string palette "#e7e9db:#ef6155:#48b685:#fec418:#06b6ef:#815ba4:#5bc4bf:#a39e9b:#776e71:#ef6155:#48b685:#fec418:#06b6ef:#815ba4:#5bc4bf:#2f1e2e"
gset string background_color "#e7e9db"
gset string foreground_color "#4f424c"
gset string bold_color "#4f424c"
