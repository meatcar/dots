...
gset string palette "#FDF4C1:#FB543F:#95C085:#FAC03B:#0D6678:#8F4673:#8BA59B:#A89984:#665C54:#FB543F:#95C085:#FAC03B:#0D6678:#8F4673:#8BA59B:#1D2021"
gset string background_color "#FDF4C1"
