#!/usr/bin/env bash
# Base16 Isotope - Gnome Terminal color scheme install script
# Jan T. Sott
...
gset string palette "#ffffff:#ff0000:#33ff00:#ff0099:#0066ff:#cc00ff:#00ffff:#d0d0d0:#808080:#ff0000:#33ff00:#ff0099:#0066ff:#cc00ff:#00ffff:#000000"
gset string background_color "#ffffff"
gset string foreground_color "#606060"
gset string bold_color "#606060"
