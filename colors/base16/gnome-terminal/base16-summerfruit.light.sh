#!/usr/bin/env bash
# Base16 Summerfruit - Gnome Terminal color scheme install script
...
gset string palette "#FFFFFF:#FF0086:#00C918:#ABA800:#3777E6:#AD00A1:#1faaaa:#D0D0D0:#505050:#FF0086:#00C918:#ABA800:#3777E6:#AD00A1:#1faaaa:#151515"
