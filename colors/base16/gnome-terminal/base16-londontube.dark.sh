#!/usr/bin/env bash
# Base16 London Tube - Gnome Terminal color scheme install script
# Jan T. Sott
...
gset string palette "#231f20:#ee2e24:#00853e:#ffd204:#009ddc:#98005d:#85cebc:#d9d8d8:#737171:#ee2e24:#00853e:#ffd204:#009ddc:#98005d:#85cebc:#ffffff"
gset string background_color "#231f20"
gset string foreground_color "#d9d8d8"
gset string bold_color "#d9d8d8"
