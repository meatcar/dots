...
gset string palette "#baae9e:#cf6a4c:#54be0d:#f9ee98:#5ea6ea:#9b859d:#afc4db:#8a8986:#666666:#cf6a4c:#54be0d:#f9ee98:#5ea6ea:#9b859d:#afc4db:#28211c"
gset string background_color "#baae9e"
gset string foreground_color "#5e5d5c"
gset string bold_color "#5e5d5c"
