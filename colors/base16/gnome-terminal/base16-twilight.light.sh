...
gset string palette "#ffffff:#cf6a4c:#8f9d6a:#f9ee98:#7587a6:#9b859d:#afc4db:#a7a7a7:#5f5a60:#cf6a4c:#8f9d6a:#f9ee98:#7587a6:#9b859d:#afc4db:#1e1e1e"
gset string background_color "#ffffff"
gset string foreground_color "#464b50"
gset string bold_color "#464b50"
