#!/usr/bin/env bash
# Base16 Colors - Gnome Terminal color scheme install script
# mrmrs (http://clrs.cc)
...
gset string palette "#ffffff:#ff4136:#2ecc40:#ffdc00:#0074d9:#b10dc9:#7fdbff:#bbbbbb:#777777:#ff4136:#2ecc40:#ffdc00:#0074d9:#b10dc9:#7fdbff:#111111"
gset string background_color "#ffffff"
gset string foreground_color "#555555"
gset string bold_color "#555555"
