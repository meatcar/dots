...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#001100', '#007700', '#00bb00', '#007700', '#009900', '#00bb00', '#005500', '#00bb00', '#007700', '#007700', '#00bb00', '#007700', '#009900', '#00bb00', '#005500', '#00ff00']"
        dset background-color "'#001100'"
        dset foreground-color "'#00bb00'"
        dset bold-color "'#00bb00'"
