...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 OceanicNext Light"
...
gset string palette "#D8DEE9:#EC5f67:#99C794:#FAC863:#6699CC:#C594C5:#5FB3B3:#C0C5CE:#65737E:#EC5f67:#99C794:#FAC863:#6699CC:#C594C5:#5FB3B3:#1B2B34"
gset string background_color "#D8DEE9"
gset string foreground_color "#4F5B66"
gset string bold_color "#4F5B66"
