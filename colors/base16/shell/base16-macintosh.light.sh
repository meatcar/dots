#!/bin/sh
# Base16 Macintosh - Shell color setup script
...
color_foreground="40/40/40" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="40/40/40" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 404040 # forground
