#!/bin/sh
# Base16 Hopscotch - Shell color setup script
# Jan T. Sott
...
color_foreground="5c/54/5b" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="5c/54/5b" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 5c545b # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 5c545b # bold color
  printf $printf_template_custom Pj b9b5b8 # selection color
  printf $printf_template_custom Pk 5c545b # selected text color
  printf $printf_template_custom Pl 5c545b # cursor
