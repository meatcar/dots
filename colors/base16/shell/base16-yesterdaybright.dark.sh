#!/bin/sh
# Base16 Yesterday Bright - Shell color setup script
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg dfe1e8 # forground
  printf $printf_template_custom Ph 343d46 # background
  printf $printf_template_custom Pi dfe1e8 # bold color
  printf $printf_template_custom Pj 65737e # selection color
  printf $printf_template_custom Pk dfe1e8 # selected text color
  printf $printf_template_custom Pl dfe1e8 # cursor
  printf $printf_template_custom Pm 343d46 # cursor text
else
