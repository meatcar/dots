#!/bin/sh
# Base16 Seti UI - Shell color setup script
# 
...
color_foreground="3B/75/8C" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="3B/75/8C" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 3B758C # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 3B758C # bold color
  printf $printf_template_custom Pj d6d6d6 # selection color
  printf $printf_template_custom Pk 3B758C # selected text color
  printf $printf_template_custom Pl 3B758C # cursor
