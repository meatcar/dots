#!/bin/sh
# Base16 IR Black - Shell color setup script
...
color_foreground="48/48/44" # Base 02
color_background="fd/fb/ee" # Base 07
color_cursor="48/48/44" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 484844 # forground
  printf $printf_template_custom Ph fdfbee # background
  printf $printf_template_custom Pi 484844 # bold color
  printf $printf_template_custom Pj b5b3aa # selection color
  printf $printf_template_custom Pk 484844 # selected text color
  printf $printf_template_custom Pl 484844 # cursor
  printf $printf_template_custom Pm fdfbee # cursor text
else
